 ...
 */
if(typeof isomorphicDir == 'undefined'){isomorphicDir = 'serverlibrarymanager/sc/';}
...
,isc.A.$kz=function isc_c_EventHandler___handleMouseMove(_1,_2){var _3=this;var _4;if(isc.Browser.isIE){var _5=_3.$j6,_6=_2.buttonNum;if(_5){if(_6==0){_4=true}}else if(_6==1&&_2.eventType==_3.MOUSE_MOVE){if(_3.$94o){}else{_2.eventType=_3.MOUSE_DOWN;_3.handleMouseDown(null,_2);_2.eventType=_3.MOUSE_MOVE}}}
...
,isc.A.handleMouseUp=function isc_c_EventHandler_handleMouseUp(_1,_2){if(isc.Browser.isTouch&&!_2)return;var _3=isc.EH;if(isc.Browser.isIE&&!_3.$j6){if(_3.$94o)return;var _4=_3.lastEvent;_4.eventType=_3.MOUSE_DOWN;_3.handleMouseDown(null,_3.lastEvent)}
_3.$94o=_2;if(!_2)_3.$ku=true;var _5=_3.$k5(_1,_2);_3.$ku=false;if(isc.Browser.isSafari)_5=true;return _5}
...
return null}
);isc.evalBoundary;isc.B.push(isc.A.$mz=function isc_c_EventHandler__hardMaskTargets(_1,_2,_3,_4){if(!_1)return;if(_3){for(var _5 in _1){var _6=this.$m2(_5);this.$m7(_6,_2,_4)}}else{for(var i=0;i<_1.length;i++){var _6=this.$m2(_1[i]);this.$m7(_6,_2,_4)}}}
...
if(this.parentElement!=null){var _22=_1,_23=_2;if(_22!=null){_22-=(_11!=null?_11:this.getScrollLeft());_22+=this.getOffsetLeft()}
if(_23!=null){_23-=(_12!=null?_12:this.getScrollTop());_23+=this.getOffsetTop()}
...
var _6=this.getSelectionObject(_3);if(_6){this.$67j=true;_6.selectList(_1,_2,_3);this.$67j=null;this.markForRedraw();this.fireSelectionUpdated()}}
...
);isc.evalBoundary;isc.B.push(isc.A.editHilites=function isc_Canvas_editHilites(){var _1=this.getAllFields();if(!_1)return;var _2=_1?_1.findAll("canHilite",false):null;if(_2&&_2.length>0){_1.removeList(_2)}
