...
if(_3==null)_3=_1.name;var _4=_2?_2.valueType:"text",_5=isc.SimpleType.getType(_1.type)||isc.SimpleType.getType("text"),_6=[],_7,_8=null;_5=_5.name;_8=this.getEditorType(_1,_2.ID);if(_4=="fieldType"||_4=="custom"||_4=="valueSet"){var _9=_5;if(_4=="valueSet"){_8="TextAreaItem"}else if(_4=="custom"&&_2&&_2.editorType){_8=_2.editorType}
var _10=isc.addProperties({type:_9,valueType:_4,name:_1.name,showTitle:false,title:this.valueItemTitle,width:this.valueItemWidth,changed:function(){this.form.creator.valueChanged(this,this.form)}},this.getValueFieldProperties(_1.type,_3,_2.ID,"value"));if(_8)_10.editorType=_8;if(_4=="valueSet"){_10.multiple=true;_10.showHintInField=true;_10.hint=this.valueSetHint;_10.parseEditorValue=function(_16,_17,_18){if(_16==null)return _16;return _16.split(",")};_10.formatEditorValue=function(_16,_17,_18,_19){if(_16==null)return"";if(isc.isAn.Array(_16)){return _16.join(",")}
return _16}}
